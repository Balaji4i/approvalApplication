...
import fusion.apr.model.POJO.pojo_atr5;
...
// ---------------------------------------------------------------------
public class Attribute5_PROGVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public Attribute5_PROGVOImpl() {
    }
...
//            con = getConnectionDS("subcont1");
            ...
            rs =
 stmt.executeQuery("select * from xxfnd_appr_attributes where ATTRIBUTE_COLUMN='ATTRIBUTE5' and ATTR_GRP_ID = '" +
                   Aid + "'");
...
"select " + b + "," + c + " from xxfnd_lookup_types t, " + a +
  ...
  d + "'";
            ...
            while (rs1.next()) {
                ...
                characterList.add(new pojo_atr5(rs1.getString(1),
                                                rs1.getString(2)));
    ...
    private ArrayList<pojo_atr5> characterList = new ArrayList<pojo_atr5>();
    ...
    protected ViewRowImpl createRowFromResultSet(Object qc,
        ...
        // Create a new row
        Attribute5_PROGVORowImpl characterRow =
            (Attribute5_PROGVORowImpl)createNewRowForCollection(qc);
        //Here set attribute values in new row using RowImpl class
        characterRow.setAtr5Key(characterList.get(curIndex).getId());
        characterRow.setAtr5Value(characterList.get(curIndex).getName());
