...
import fusion.apr.model.POJO.pojo_atr4;
...
// ---------------------------------------------------------------------
public class Attribute4_PROGVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public Attribute4_PROGVOImpl() {
    }
...
//            con = getConnectionDS("subcont1");
            ...
            rs =
 stmt.executeQuery("select * from xxfnd_appr_attributes where ATTRIBUTE_COLUMN='ATTRIBUTE4' and ATTR_GRP_ID = '" +
                   Aid + "'");
...
"select " + b + "," + c + " from xxfnd_lookup_types t, " + a +
  ...
  d + "'";
            ...
            while (rs1.next()) {
                ...
                characterList.add(new pojo_atr4(rs1.getString(1),
                                                rs1.getString(2)));
    ...
    private ArrayList<pojo_atr4> characterList = new ArrayList<pojo_atr4>();
    ...
    protected ViewRowImpl createRowFromResultSet(Object qc,
        ...
        // Create a new row
        Attribute4_PROGVORowImpl characterRow =
            (Attribute4_PROGVORowImpl)createNewRowForCollection(qc);
        //Here set attribute values in new row using RowImpl class
        characterRow.setAtr4Key(characterList.get(curIndex).getId());
        characterRow.setAtr4Value(characterList.get(curIndex).getName());
