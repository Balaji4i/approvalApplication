...
public class ADFUtils implements java.io.Serializable {
    ...
    public static final ADFLogger LOG =
    ...
    public static DCDataControl getDataControl(String name) {
        DCDataControl cDataControl =
            BindingContext.getCurrent().findDataControl(name);
        if (cDataControl == null) {
            throw new RuntimeException("DataControl with name: " + name +
                                       " doesn't exist.");
        }
        return cDataControl;
    }
    ...
    public static MultiMap keyAttrListForIterator(DCIteratorBinding iter,
                                                  String[] keyAttrName) {
    ...
    public static DCIteratorBinding findIterator(String bindingContainer,
        ...
        DCBindingContainer bindings =
            BindingContext.getCurrent().findBindingContainer(bindingContainer);
        if (bindings == null) {
    ...
    public static OperationBinding findOperation(String bindingContianer,
                                                 String opName) {
        DCBindingContainer bindings =
            BindingContext.getCurrent().findBindingContainer(bindingContianer);
        if (bindings == null) {
            throw new RuntimeException("Binding container '" +
    ...
    //                    appModule =
    //                            bindings.getDataControl().getApplicationModule();
    //                }
    //            }
    //            if (appModule == null && name != null) {
    //                appModule =
    //                        (ApplicationModule)JSFUtils.resolveExpression("#{data." +
    //                                                                      name +
    //                                                                      ".dataProvider}");
    //                if (appModule == null) {
    ...
    //                    appModule =
    //                            dcBindingContainer.getDataControl().getApplicationModule();
    //                }
    ...
    //                    getApplicationModuleForDataControl(null);
    //                if (appModule != null) {
    ...
    public static void resetValueInputItems(AdfFacesContext adfFacesContext,
        ...
        for (UIComponent item : items) {
            ...
            if (checkSuperClassInstance(item.getClass(),
                                        UIXTable.class.getName())) {
                UIXTable ut = (UIXTable)item;
                ut.resetStampState();
                adfFacesContext.addPartialTarget(ut);
            }
            if (checkSuperClassInstance(item.getClass(),
                                        UIXEditableValue.class.getName())) {
     ...
     * @return
     */
    public static boolean checkSuperClassInstance(Class parentClassname,
     ...
     * @param value
     */
    public static void setUIComponentProperty(String uiComptntId,
            ...
            if (uiComptntId != null && property != null) {
                ...
                if (uic != null) {
                    if (uic instanceof RichCommandButton) {
                        ...
                        PropertyKey propKey =
                            uev.getFacesBean().getType().findKey(property);
                        if (propKey != null) {
                            if (propKey.getName().equalsIgnoreCase("readOnly") &&
                                uev.getValue() == null) {
                                ...
                                if (uev.getValue() instanceof Boolean) {
                                    ...
                                    uev.getFacesBean().setProperty(propKey,
                                                                   value);
                                }
                            }
                    ...
                    System.out.println("UIComponent Not found for the given Id : " +
                                       uiComptntId);
                }
            } else {
